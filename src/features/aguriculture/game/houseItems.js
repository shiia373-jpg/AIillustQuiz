...
const HOUSE_ITEMS = {
  ...
  wall_golden:    { name: '黄金の壁',       category: 'wall', price: 5000,   color: '#FFD700', accent: '#C89000',
  ...
  roof_golden:    { name: '黄金屋根',       category: 'roof', price: 3000,   color: '#FFD700', peak: '#E8A000',
  ...
  wp_golden:      { name: '黄金の壁紙',     category: 'wallpaper', price: 8000,   color: '#E8C000',
